...
%     make_proto - p
    ...
    methods
        function self = PsychTexture
            ...
            self.draw_array = struct('source_rect', [], ...
                                   'rect', [0 0 100 100], ...
                                   'rotation_angle', 0, ...
            ...
            self.make_array = struct('pointer', [], 'window_index', [], ...
                                          'original_matrix', [], ...
        ...
        % Draw selected textures
            Screen('DrawTextures', pointer, [self.make_array(indices).pointer], ...
                   reshape([self.draw_array(indices).source_rect], [], 2), ...
                   reshape([self.draw_array(indices).rect], [], 2), ...
